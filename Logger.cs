...
namespace System
{
    ...
    public partial class Logger : ILogger
    {
        ...
        internal Logger(LOG.LoggerFactory loggerFactory, IHttpContextAccessor httpContextAccessor)
        {
        ...
        private void LogToFile<TState>(LoggerInformation loggerInfo, LogLevel logLevel,
            ...
            Func<TState, Exception, string> formatter)
        {
            ...
            if (!string.IsNullOrEmpty(eventId.Name))
            {
                ...
                path = Path.Combine(LoggerSettings.LogDirectory, (exception != null ? LogLevel.Error : logLevel).ToString(),
                ...
                if (context != null)
                {
                    ...
                    if (!context.IsFile() && (context.Request.ContentLength > 0 || context.Request.HasFormContentType))
                    {
                        ...
                        else
                        {
                            ...
                            StreamReader sr = new System.IO.StreamReader(context.Request.Body);
            ...
            LOG.LoggerFactory.Contents.Add(new LoggerContent { Path = path, Message = message.ToString() });
            message.Clear();
            message = null;
        }
